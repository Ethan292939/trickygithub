...
exports.chooseBossName = (code, n) => {
    ...
    case 'ny1':
    return exports.chooseN([
        'POWER BOSS AAAAAA',// POWER BOSS AAAAAA
    ], n);
    case 'ny1upgrade':
    return exports.BossUpgrade([
         exports.ny2 = (exports.BossUpgrade.timer === 90), (this.settings.broadcastMessage = 'the boss has upgraded to NY2!')
    ], n);
    case 'ny2upgrade':
    return exports.BossUpgrade([
         exports.ny3 = (exports.BossUpgrade.timer === 90), (this.settings.broadcastMessage = 'the boss has upgraded to NY3!')
    ], n);
    default: return 'God';//Lets make it 1 Minute 30 secs
    }
};//code it idk to make it work
//can you make it auto upgrade? | ok | but the timer to be 3 mins or 4 | timer being 3 minutes. NY-1 upgrades to NY-2 and NY-2 upgrades to NY-3 | ok
/*
*/
//Stop killing me tricky | ok